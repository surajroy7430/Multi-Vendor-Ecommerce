...
import { watchCartBadge } from "../Users/app.js";
...
export function authListener() {
    onAuthStateChanged(auth, async (user) => {
        ...
        let role = "", name = "", dashboardUrl = "", cartUrl = "";

        if (userDoc.exists()) {
            role = "User";
            name = userDoc.data().name;
            dashboardUrl = "/Users/Dashboard.html";
            cartUrl = "/Users/Cart.html";
        } else if (vendorDoc.exists()) {
            role = "Vendor";
            name = vendorDoc.data().businessName;
            dashboardUrl = "/Vendors/Dashboard.html";
        }
            ...
            navbar.innerHTML = `
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        ${role === "User" ? '<li><a class="dropdown-item" href="/Users/My-Orders.html">My Orders</a></li>' : ""}
                        ${role === "Vendor" ? '<li><a class="dropdown-item" href="/Vendors/My-Products.html">My Products</a></li>' : ""}
        ...
        if (accountMenu) {
            accountMenu.innerHTML = `
                ...
                ${role === "User" ? '<a href="/Users/My-Orders.html">My Orders</a>' : ""}
                ${role === "Vendor" ? '<a href="/Vendors/My-Products.html">My Products</a>' : ""}
